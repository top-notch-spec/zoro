...
import {
  ...
  useGetIsolatedAssetsInAccount,
  useGetIsolatedMarkets,
...
const useGetIsolatedAssets = ({
  ...
  const { data: getMainMarketsData, isLoading: isGetMainMarketsLoading } = useGetIsolatedMarkets();
  ...
  const data = useMemo(() => {
    ...
    const {
      ...
      (acc, market) => {
        ...
        //console.log("vTokenBalances =>", vTokenBalances);
...
export default useGetIsolatedAssets;
